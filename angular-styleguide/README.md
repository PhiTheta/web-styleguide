...
*Opinionated Angular style guide for RedMart teams by RedMart teams*

    The purpose of this style guide is to provide guidance on building Angular applications by showing the conventions.
...
###### [Style [Y020](#style-y020)]
  ...
  *Why?*: Unique names help avoid module name collisions. Separators help define modules and their submodule hierarchy. For example `console` may be your root module while `console.dashboard` and `console.users` may be modules that are used as dependencies of `console`.
...
###### [Style [Y121](#style-y121)]
  ...
  - Use consistent names for all components following a pattern that describes the component's feature then (optionally) its type. Recommended pattern is `feature.type.js` or `long-name-feature.type.js` for longer names.
...
###### [Style [Y220](#style-y220)]
  ...
  - We don't use comments. Use description of test case instead.
...
###### [Style [Y252](#style-y252)]
  ...
  - Angular snippets and file templates that follow these styles and guidelines. You can import them into your WebStorm settings:
    ...
    - Download the [WebStorm Angular file templates and snippets](assets/settings.jar?raw=true)
